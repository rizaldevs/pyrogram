...
class SavedInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.payments.SavedInfo`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetSavedInfo <pyrogram.raw.functions.payments.GetSavedInfo>`
    """
